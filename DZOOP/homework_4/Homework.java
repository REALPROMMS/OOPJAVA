package OOPJAVA.DZOOP.homework_4;
...
public class Homework {
    ...
    public static void shiftFruBox(Box<?> b1, Box<?> b2){
        ...
        if((b1.name).equals(b2.name)){
            ...
            b1.weight = 0;
            System.out.printf("Коробку №%d опустошили, вес коробки №%d - %.2f кг\n\n", b1.getId(), b2.getId(), b1.weight + b2.weight);
        }
    ...
    public static void main(String[] args) {
        ...
        Box<Apple> box1 = new Box<Apple>(fillTheAppleBox(5));
        Box<Apple> box2 = new Box<Apple>(fillTheAppleBox(10));
        Box<Orange> box3 = new Box<Orange>(fillTheOrangeBox(7));
        Box<Orange> box4 = new Box<Orange>(fillTheOrangeBox(20));
